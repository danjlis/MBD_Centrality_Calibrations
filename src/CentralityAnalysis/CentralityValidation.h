...
class CentralityValidation : public SubsysReco
{
 public:
  //! constructor
  explicit CentralityValidation(const std::string &name = "CentralityValidation", const std::string &hist_name = "QA_CentralityReco.root");

  //! destructor
  virtual ~CentralityValidation();
