...
void Fun4All_MbdCalibrationAnalysis(const int runnumber, const int rollover = 0)
{
  ...
  const char *tree_outfile = Form("/gpfs02/sphenix/user/dlis/Projects/centrality/output/run%d/mbd_calib_ana_tree_%s_%s.root", runnumber, rstr.str().c_str(), ostr.str().c_str());
