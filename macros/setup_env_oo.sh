...
export MBD_SIM_CENTRALITY_FINAL_PATH=/sphenix/user/dlis/Projects/centrality/cdb/calibrations_sim/

export MC_GENERATOR=hijing

export DST_SOURCE_PATH=/sphenix/lustre01/sphnxpro/production/run_00020800_00020900/

export DST_NAME=DST_CALO_run1auau_ana412_2023p015

export CDB_TAG=ProdA_2024

#export NOPAYLOADCLIENT_CONF=/sphenix/user/dlis/Projects/centrality/cdb/macros/CDBTest/mycdb.json

mkdir $MBD_CENTRALITY_OUTPUT_PATH
mkdir $MBD_CENTRALITY_CALIB_PATH
mkdir $MBD_CENTRALITY_FINAL_PATH
