...
void QA_CentralityCheck(const int runnumber, const int centrality_runnumber = 21813)
{
  ...
  TH1D *h_cent_bin = new TH1D("hcent_bins","", 19, -0.5, 18.5);
  ...
  h_cent_bin->Scale(.93/h_cent_bin->Integral());
...
void QA_ZDCCheck(const int runnumber)
{
  ...
  TH1D *h_zdc_sum_n = new TH1D("h_zdc_sum_n", ";ZDC sum [GeV]; Counts", 500, 1, 10000);
  TH1D *h_zdc_sum_s = new TH1D("h_zdc_sum_s", ";ZDC sum [GeV]; Counts", 500, 1, 10000);
